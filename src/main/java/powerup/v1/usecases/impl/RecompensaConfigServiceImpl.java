...
public class RecompensaConfigServiceImpl implements RecompensaConfigService {
    ...
    @Override
    public RecompensaConfigRequestDto create(RecompensaConfig recompensaConfig) {
    ...
    @Override
    public RecompensaConfigRequestDto update(Integer id, RecompensaConfig recompensaConfig) {
